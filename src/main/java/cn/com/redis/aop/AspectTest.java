...
import cn.com.redis.untils.RedisUtils2;
...
public class AspectTest {
	...
	private static void redisInsert(List<Column> columns) {
		...
		if (columns.size() > 0) {
			RedisUtils2.stringSet("user:" + columns.get(0).getValue(),
					json.toJSONString());
		}
	}
	...
	private static void redisDelete(List<Column> columns) {
		...
		if (columns.size() > 0) {
			RedisUtils2.delKey("user:" + columns.get(0).getValue());
		}
	}
}
